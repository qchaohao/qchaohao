...
### 标签规定
  ...
  >- @@..>.. **NOTE** 重要的提示或背景信息‌，**与众不同的**。mark里使用粗体或粗斜体。
  >- @@..!.. **FOOL** 不能忘记或不能更改的，<sup>**不能出错的**</sup>。mark里使用粗体上标。
  >- @@..$.. **DOIT** 已知问题或需要修复的，<sub>**赶紧去做的**</sub>。mark里使用粗体下标。
  >- @@..=.. **DEAD** 有争议或有重启的价值，~~历史信息的~~。mark里只用删除线。
  >- @@..;.. **DEAD** 用于黑色主题。
  >- @@..+.. **TODO** 待完成的或要待实现的，**未想明白的[^t1]**。mark里使用粗体脚注,t1开头。
  >- @@..?.. **TODO** 用于黑色主题。
