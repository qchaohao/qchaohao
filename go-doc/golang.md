...
### 作者简介
  ...
  - 谷歌2009年发布的第二款开源编程语言，专门针对多处理器系统应用程序的编程进行了优化。
  - 2007年末由 ***Ken Thompson, Rob Pike, Robert Griesemer*** 主持开发。
  - 后来还加入了曾改善开源码编译器 ***GCC 的 Ian Lance Taylor，Plan9开发者 Russ Cox *** 等人。
  - 最终于 ***2009年11月*** 开源，在 ***2012年*** 早些时候发布了 Go 1 稳定版本。
  - **肯尼斯·蓝·汤普森（Kenneth Lane Thompson）<sup>!!!</sup>**，1943年2月4日生于 ***美国的新奥尔良***。
  - Ken 是 **B语言、C语言的作者、Unix之父<sup>!!!</sup>**，***1983年图灵奖（Turing Award）***得主。
  - Ken 还是 ***1998年美国国家技术奖（National Medal of Technology）*** 得主。
  - **罗勃特·派克（Robert C. Pike）<sup>!!!</sup>**，1956年生，来自于 ***加拿大***。
  - Rob 曾是 ***贝尔实验室（Bell Labs）*** 的Unix团队，和 ***Plan9操作系统*** 计划的成员。
  - Rob 与 Ken 共事多年，并共创出广泛使用的 ***UTF-8 字元编码***。
  - **罗勃特·格瑞史莫（Robert Griesemer）<sup>!!!</sup>**，1964年生，来自于 ***瑞士***。
  - Griesemer 曾协助制作Java的 ***HotSpot编译器***，和Chrome浏览器的 ***JavaScript引擎V8***。
  - ![作者简介](./creator.jpg)

### 版本历史

  - 2009年11月10日，以开放源代码的方式向全球发布。
  - 2010年1月10日，摘得了 ***TIOBE*** 公布的2009年年度大奖。
  - 2011年3月16日，第一个稳定（stable）版本 ***r56*** 发布。
  - 2012年3月28日，第一个正式版本 ***Go 1*** 发布
  - 2013年4月04日，第一个 ***Go 1.1beta1*** 测试版本发布。
  - 2013年4月08日，第二个 ***Go 1.1beta2*** 测试版本发布。
  - 2013年5月02日，***Go 1.1RC1*** 版本发布。
  - 2013年5月07日，***Go 1.1RC2*** 版本发布。
  - 2013年5月09日，***Go 1.1RC3*** 版本发布。 
  - 2013年5月13日，***Go 1.1*** 正式版发布。
  - 2013年9月20日，***Go 1.2RC1*** 版本发布。
  - 2014年6月19日，***Go 1.3*** 版本发布。
  - 2015年8月20日，***Go 1.5*** 版本发布，本次更新中移除了 ”最后残余的C代码“。
  - 2016年2月17日，***Go 1.6*** 版本发布，本次开始全面支持 HTTP/2 国际标准。
  - 2016年8月15日，***Go 1.7*** 版本发布。
  - 2017年2月17日，***Go 1.8*** 版本发布。
  - 2017年8月24日，***Go 1.9*** 版本发布。
  - 2018年2月16日，***Go 1.10*** 版本发布。

### 特性特点
  
  - ***简单易学***，几乎支持大多数你在其他语言见过的特性：继承、重载、对象等。
  - ***媲美 C 或 C++ 代码的速度***，而且更加安全。
  - ***可直接跨平台编译成机器码***，不依赖其他库。
  - ***语言层面支持并发***，充分发挥多核心处理器同步多工的优点。
  - ***丰富的标准库***，特别是网络编程库非常强大。
  - ***支持面向对象***，具有真正的闭包（closures）和反射（reflection）等功能。
  - 静态类型的语言就是可以在编译的时候检查出来隐藏的大多数问题。
  - ***应用广泛***，如 云平台，分布式系统，内存数据库，数据库代理器等。

## 编码规范

### 命名规范

  - 标识符必须是字母、数字和下划线组成，首位不能是数字并对大小写敏感。
